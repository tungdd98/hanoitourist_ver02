<%@ Page Title="" Language="C#" MasterPageFile="~/layouts/_admin.Master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="hanoitourist_ver02.admin.user.create" %>
    ...
    <h1 class="display-4">Thêm mới</h1>
     <form id="form1" runat="server">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <asp:Label Text="Xác nhận mật khẩu" runat="server" />
            <asp:TextBox ID="cfPasswords" runat="server" CssClass="form-control" type="text" required="true"></asp:TextBox>
        </div>
         <div class="form-group">
