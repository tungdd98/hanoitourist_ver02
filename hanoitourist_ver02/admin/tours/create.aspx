<%@ Page Title="" Language="C#" MasterPageFile="~/layouts/_admin.Master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="hanoitourist_ver02.admin.tours.create" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <form id="form1" runat="server">
        <div class="form-group">
            <asp:Label Text="Mã tour" runat="server" />
            <asp:TextBox ID="id" runat="server" CssClass="form-control" type="text" required="true"></asp:TextBox>
        </div>
        <div class="form-group">
