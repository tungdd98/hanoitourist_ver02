...
namespace hanoitourist_ver02.admin.tours
{
    public partial class create : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if(!bus.Insert(dto.Id, dto.Title, dto.Thumbnail, dto.Description, dto.Content, dto.DepartureLocationId, dto.DestinationLocationId, dto.TimeId, dto.VehicleId, dto.Place, dto.Schedule))
            {
