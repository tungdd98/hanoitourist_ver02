<%@ Page Title="" Language="C#" MasterPageFile="~/layouts/_admin.Master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="hanoitourist_ver02.admin.countries.create" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:DropDownList ID="isNation" runat="server" CssClass="form-control">
                <asp:ListItem Selected="True" Value="0">Trong nước</asp:ListItem>
